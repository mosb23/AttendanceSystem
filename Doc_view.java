...
public class Doc_view extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Doctor_ID", "Name", "Username", "Department", "Contact", "Email", "Gender"
            }
        ) {
    ...
    private void loadAllDoctors() {
        try (Connection con = ConnectionProvider.getCon();
             PreparedStatement stmt = con.prepareStatement("SELECT doctor_id, name, username, department_name, contact , email, gender " +
                                                            "FROM doctor JOIN department ON doctor.department_id = department.department_id")) {
  ...
  private void filterAndDisplayStudents(String searchText) {
     if (searchText.isEmpty()) {
            loadAllDoctors(); // Load all students when search field is empty
        } else {
            try (Connection con = ConnectionProvider.getCon();
                 PreparedStatement stmt = con.prepareStatement("SELECT doctor_id, name, username, department_name, contact, email, gender " +
                                                            "FROM doctor JOIN department ON doctor.department_id = department.department_id " +
